  ...
  return (
    <div className="home-container">
      ...
      <Navbar8
        ...
        page2={
          <Fragment>
            <span className="home-text106 thq-body-large">Services</span>
          </Fragment>
        }
        link4={
          <Fragment>
      ...
      <Features24
        ...
        feature3Title={
          <Fragment>
            <span className="home-text119 thq-heading-2">Expert Guidance</span>
          </Fragment>
        }
        feature2Description={
          <Fragment>
      ...
      <Pricing14
        ...
        plan2Yearly={
          <Fragment>
            <span className="home-text146 thq-body-large">$1799</span>
          </Fragment>
        }
        plan1Action1={
          <Fragment>
        ...
        plan3Yearly={
          <Fragment>
            <span className="home-text172 thq-body-large">$2699</span>
          </Fragment>
        }
        plan3Feature4={
          <Fragment>
        ...
        plan1Yearly={
          <Fragment>
            <span className="home-text177 thq-body-large">$899</span>
          </Fragment>
        }
        plan1Feature1={
          <Fragment>
            <span className="home-text178 thq-body-small">LLC Formation</span>
          </Fragment>
        }
        plan3Feature3={
          <Fragment>
      ...
      <Testimonial17
        ...
        author4Position={
          <Fragment>
            <span className="home-text200 thq-body-small">Entrepreneur</span>
          </Fragment>
        }
        author4Name={
          <Fragment>
      ...
      <Footer4
        link5={
          <Fragment>
            <span className="home-text214 thq-body-small">FAQs</span>
          </Fragment>
        }
        link3={
          <Fragment>
