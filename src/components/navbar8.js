          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text22">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
            <a
              href="https://llc-nepal.vercel.app"
              target="_blank"
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text19 thq-body-small">
                                  Explore our range of services for setting up
                                  and managing LLCs.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span>
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text19 thq-body-small">
                            Explore our range of services for setting up and
                            managing LLCs.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page4ImageAlt: 'Image representing Contact page',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1681164315462-9a41cb6d77f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTQ0NTc1M3w&ixlib=rb-4.0.3&q=80&w=1080',
  link1: undefined,
  page2ImageAlt: 'Image representing Services page',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1709606703981-1e011ae6058c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTQ0NTc1MHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1695705225534-5a34bf2b3ca5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTQ0NTc1MXw&ixlib=rb-4.0.3&q=80&w=1080',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1577415124269-fc1140a69e91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTQ0NTc1MXw&ixlib=rb-4.0.3&q=80&w=1080',
