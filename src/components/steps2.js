                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Understand the legal requirements and regulations for
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Select a unique and distinguishable name that complies
                      with state naming rules.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Prepare and submit the required formation document with
                      the state to officially create your LLC.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Draft an operating agreement outlining ownership and
                      operating procedures for your LLC.
                    </span>
                  </Fragment>
                )}
              </span>
